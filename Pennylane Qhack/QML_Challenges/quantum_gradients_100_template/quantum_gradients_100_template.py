...
def parameter_shift(weights):
    ...
    # QHACK #
    #
    def parameter_shift1(qnode,weights,i,j):
    ...
    def parameter_shift2(qnode,weights):
        for i in range(len(weights)):
            gradient[i,0] = parameter_shift1(qnode,weights,i,0)
            gradient[i,1] = parameter_shift1(qnode,weights,i,1)
            gradient[i,2] = parameter_shift1(qnode,weights,i,2)
